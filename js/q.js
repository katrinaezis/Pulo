...
PeerIo.prototype.loadMessages = function() {
  ...
  var setMessage = function(data) {
    var val = data.val();
    this.displayMessage(data.key, val.name, val.title, val.body, val.photoUrl, val.imageUrl);
  }.bind(this);
...
PeerIo.MESSAGE_TEMPLATE =
    '<div class="message-container">' +
      ...
      '<h4 class="message"></h4>' +
      '<div class="messageBody grey-text text-darken-2"></div>' +
      '<div class="name"></div>' +
    '</div>';
...
PeerIo.prototype.displayMessage = function(key, name, title, body, picUrl) {
